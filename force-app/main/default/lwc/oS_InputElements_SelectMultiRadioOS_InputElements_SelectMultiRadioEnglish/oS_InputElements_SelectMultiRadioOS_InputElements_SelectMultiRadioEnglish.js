...
import { OMNIDEF } from './oS_InputElements_SelectMultiRadioOS_InputElements_SelectMultiRadioEnglish_def.js';
import tmpl from './oS_InputElements_SelectMultiRadioOS_InputElements_SelectMultiRadioEnglish.html';
import tmpl_nds from './oS_InputElements_SelectMultiRadioOS_InputElements_SelectMultiRadioEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_InputElements_SelectMultiRadioOS_InputElements_SelectMultiRadioEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
