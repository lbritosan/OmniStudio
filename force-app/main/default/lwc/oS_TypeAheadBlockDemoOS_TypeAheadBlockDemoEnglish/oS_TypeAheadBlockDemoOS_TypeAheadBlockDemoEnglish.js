...
import { OMNIDEF } from './oS_TypeAheadBlockDemoOS_TypeAheadBlockDemoEnglish_def.js';
import tmpl from './oS_TypeAheadBlockDemoOS_TypeAheadBlockDemoEnglish.html';
import tmpl_nds from './oS_TypeAheadBlockDemoOS_TypeAheadBlockDemoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_TypeAheadBlockDemoOS_TypeAheadBlockDemoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
