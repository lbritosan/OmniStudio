...
import { OMNIDEF } from './oS_IP_ActionOS_IP_ActionEnglish_def.js';
import tmpl from './oS_IP_ActionOS_IP_ActionEnglish.html';
import tmpl_nds from './oS_IP_ActionOS_IP_ActionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_IP_ActionOS_IP_ActionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
