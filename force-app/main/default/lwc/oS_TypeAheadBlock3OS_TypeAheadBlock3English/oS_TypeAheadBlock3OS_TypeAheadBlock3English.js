...
import { OMNIDEF } from './oS_TypeAheadBlock3OS_TypeAheadBlock3English_def.js';
import tmpl from './oS_TypeAheadBlock3OS_TypeAheadBlock3English.html';
import tmpl_nds from './oS_TypeAheadBlock3OS_TypeAheadBlock3English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_TypeAheadBlock3OS_TypeAheadBlock3English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
