...
import { OMNIDEF } from './oS_MergeFieldDemoOS_MergeFieldDemoEnglish_def.js';
import tmpl from './oS_MergeFieldDemoOS_MergeFieldDemoEnglish.html';
import tmpl_nds from './oS_MergeFieldDemoOS_MergeFieldDemoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_MergeFieldDemoOS_MergeFieldDemoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
