...
import { OMNIDEF } from './oS_FileUpload_ContentDocumentLinkOS_FileUpload_ContentDocumentLinkEnglish_def.js';
import tmpl from './oS_FileUpload_ContentDocumentLinkOS_FileUpload_ContentDocumentLinkEnglish.html';
import tmpl_nds from './oS_FileUpload_ContentDocumentLinkOS_FileUpload_ContentDocumentLinkEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_FileUpload_ContentDocumentLinkOS_FileUpload_ContentDocumentLinkEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
