...
import { OMNIDEF } from './oS_EditBlockOS_EditBlockEnglish_def.js';
import tmpl from './oS_EditBlockOS_EditBlockEnglish.html';
import tmpl_nds from './oS_EditBlockOS_EditBlockEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oS_EditBlockOS_EditBlockEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
